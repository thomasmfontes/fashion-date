...
export const draws=sqliteTable("draws",{id:text("id").primaryKey(),participantId:integer("participant_id").notNull(),luckyNumber:text("lucky_number").notNull(),drawnAt:text("drawn_at").notNull().default(sql`CURRENT_TIMESTAMP`)});
